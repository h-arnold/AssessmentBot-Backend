...
| (briefly explain in one complete sentence)        |
| ------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | -------------------------- |
...
| templateTask: "                                   | Page Name                                                                                             | What will that page cover? |

| (briefly explain in one complete sentence) |
| ------------------------------------------ | ---------------------------------------------------------------------------------------------- | -------------------------- |
| Home Page                                  |                                                                                                |
| Self Driving Car Technology                | I will use content blocks to illustrate each technology with an image and a short explanation. |
|                                            |                                                                                                |
|                                            |                                                                                                |
|                                            |                                                                                                |
|                                            |                                                                                                | ",                         |
